...
namespace OCCTest.Elements
{
    public class Tube: BasicElement
    {
        ...
        public Tube(double diameter, double Wallthickness, double length)
        {
            // external part
            BRepPrimAPI_MakeCylinder aMakeCylinder = new BRepPrimAPI_MakeCylinder(new gp_Ax2(new gp_Pnt(0, 0, 0), new gp_Dir(0, 0, 1)), diameter / 2, length);
            TopoDS_Shape myBody = aMakeCylinder.Shape();
            
            // internal part
            BRepPrimAPI_MakeCylinder aMakeHollowedPart = new BRepPrimAPI_MakeCylinder(new gp_Ax2(new gp_Pnt(0, 0, 0), new gp_Dir(0, 0, 1)), diameter / 2 - Wallthickness, length);
