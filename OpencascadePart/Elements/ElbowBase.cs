...
{
    public abstract class ElbowBase : BasicElement
    {


        public Length wallThickness;
        public Length bendingRadius;
        public Angle bendingAngle;
        ...
        public ElbowBase(Length wallThickness, Length bendingRadius, Angle bendingAngle)
        {
        ...
        public ElbowBase() : base() { }
        public ElbowBase(string designation, string form, int iD, int iDMaterial, string product, int quantity) : base(designation, form, iD, iDMaterial, product, quantity) { }
        public ElbowBase(string designation, string form, int iD, int iDMaterial, string product, int quantity, Length wallThickness, Length bendingRadius, Angle bendingAngle)
        ...
        public ElbowBase(string designation, string form, System.Guid GUID, int iD, int iDMaterial, string product, int quantity, Length wallThickness, Length bendingRadius, Angle bendingAngle)
            : this(designation, form, iD, iDMaterial, product, quantity, wallThickness, bendingRadius, bendingAngle)
        {
            this.GUID = GUID;
        }

        /// <summary>
        /// you can't build an elbow base...it has no L1 or L2 !
        /// </summary>
        public override void Build()
        {
            ...
            TColgp_Array1OfPnt array1 = GenerateSpline(L, bendingRad, wallThick, 0);
            TColgp_Array1OfPnt array2 = GenerateSpline(L, bendingRad, wallThick, smallShift);
        ...
        public abstract TopoDS_Wire MakeWire(double r);
       /*{
